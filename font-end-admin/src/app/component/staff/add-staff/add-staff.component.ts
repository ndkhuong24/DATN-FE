...
export class AddStaffComponent implements OnInit {
  ...
  validatePhone() {
    this.validPhone = CommonFunction.validateInput(this.Phone, null, /^(0\d{9})$/);
    // this.validPhone = CommonFunction.validateInput(this.Phone, null, /^(0|1[2-9]|2[2-9]|3[2-9]|4[2-9]|5[2-9]|6[2-9]|7[2-9]|8[2-9]|9[2-9])\d{8}$/);
  }
