...
export class SanphamComponent implements OnInit {
  ...
  constructor(private productService: ProductService , public utilService: UtilService,
              ...
              private cdr: ChangeDetectorRef,private colorService: ColorService,private sizeService : SizeService,
              private categoryService: CategoryService,private materialService: MaterialService,private soleService: SoleService
  ) {
